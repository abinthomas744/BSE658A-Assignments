...
Please use R studio to answer the questions using minimal language. Don't worry about answering the questions perfectly also!
...
5.  There are multiple columns in `AirPassengers`. Can you create a new column `Passengers` by adding all the values in different columns in a given row? The number of rows in the original dataset and the new dataset will be the same. (3 point)
