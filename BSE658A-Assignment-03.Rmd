...
7.  You might have used `Tidyverse` package to solve the above questions. Can you replace existing month columns with the percentage of passengers who flew in that month of the given year? The value of hundred percentage for a row or a year denotes the total number of passengers who flew in that particular year (which you have already calculated in the column `Passengers`). (3 points)
